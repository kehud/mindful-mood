  ...
  const reflectionTemplates = [
    {
      ...
      translations: {
        en: {
          ...
          body: "Small moments of awareness create meaningful change.",
        },
        he: {
          title: "🧠 הרפלקציה שלך",
          body: "רגעים קטנים של מודעות יוצרים שינוי משמעותי.",
        },
      },
      minCheckins: 0,
      order: 1,
    },
    {
      ...
      translations: {
        en: {
          title: "🧠 Your Reflection",
          body: "Taking a moment to listen inward is already progress.",
        },
        he: {
          title: "🧠 הרפלקציה שלך",
          body: "לעצור לרגע ולהקשיב לעצמך זו כבר התקדמות.",
        },
      },
      minCheckins: 0,
      order: 2,
    },
    {
      ...
      translations: {
        en: {
          title: "💡 Pattern",
          body: "Patterns often appear when we slow down enough to notice them.",
        },
        he: {
          title: "💡 דפוס",
          body: "לפעמים דפוסים מתגלים רק כשמסתכלים על התמונה הגדולה.",
        },
      },
      minCheckins: 0,
      order: 3,
    },
    {
      ...
      translations: {
        en: {
          title: "💡 Pattern",
          body: "Pay attention to the moments that help you feel calmer.",
        },
        he: {
          title: "💡 דפוס",
          body: "שווה לשים לב אילו רגעים תורמים יותר לתחושת רוגע.",
        },
      },
      minCheckins: 0,
      order: 4,
    },
    {
      ...
      translations: {
        en: {
          title: "🌱 Growth",
          body: "Every check-in is another step toward understanding yourself.",
        },
        he: {
          title: "🌱 צמיחה",
          body: "כל צ׳ק־אין הוא עוד צעד בהיכרות עם עצמך.",
        },
      },
      minCheckins: 0,
      order: 5,
    },
    {
      ...
      translations: {
        en: {
          title: "🌱 Growth",
          body: "Real progress is built through small, consistent steps.",
        },
        he: {
          title: "🌱 צמיחה",
          body: "התקדמות אמיתית נוצרת מצעדים קטנים ועקביים.",
        },
      },
      minCheckins: 0,
      order: 6,
    ...
    {
      label: "Feelings Welcome",
      type: "reminder",
      translations: {
        en: {
          title: "💜 Reminder",
          body: "You do not need to feel good all the time.",
        },
        he: {
          title: "💜 תזכורת",
          body: "אין צורך להרגיש טוב כל הזמן.",
        },
      },
      minCheckins: 0,
      order: 7,
    },
    {
      ...
      translations: {
        en: {
          title: "💜 Reminder",
          body: "Every feeling deserves space and attention.",
        },
        he: {
          title: "💜 תזכורת",
          body: "לכל רגש יש מקום ומשמעות.",
        },
      },
      minCheckins: 0,
      order: 8,
    },
    {
      ...
      translations: {
        en: {
          title: "✨ Inspiration",
          body: "Even a small step in the right direction is still progress.",
        },
        he: {
          title: "✨ השראה",
          body: "גם צעד קטן בכיוון הנכון הוא עדיין צעד קדימה.",
        },
      },
      minCheckins: 5,
      order: 9,
    },
    {
      ...
      translations: {
        en: {
          title: "✨ Inspiration",
          body: "Each day is a chance to understand yourself a little more.",
        },
        he: {
          title: "✨ השראה",
          body: "כל יום הוא הזדמנות חדשה להבין את עצמך קצת יותר.",
        },
      },
      minCheckins: 5,
      order: 10,
  ...
  async function main() {
    ...
    await seedCollection("reflectionTemplates", reflectionTemplates, (item) => idFromLabel(item.label));
