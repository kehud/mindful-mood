...
export const DEFAULT_MOOD_OPTIONS: readonly MoodOption[] = [
  { value: 1, label: 'Very unpleasant', translations: { en: 'Very unpleasant', he: 'מאוד לא נעים' }, icon: 'rainy-outline', color: '#6b7280', order: 1 },
  { value: 2, label: 'Unpleasant', translations: { en: 'Unpleasant', he: 'לא נעים' }, icon: 'cloud-outline', color: '#78909c', order: 2 },
  { value: 3, label: 'Slightly unpleasant', translations: { en: 'Slightly unpleasant', he: 'קצת לא נעים' }, icon: 'partly-sunny-outline', color: '#7aa7a1', order: 3 },
  { value: 4, label: 'Neutral', translations: { en: 'Neutral', he: 'ניטרלי' }, icon: 'ellipse-outline', color: '#4d8d7c', order: 4 },
  { value: 5, label: 'Slightly pleasant', translations: { en: 'Slightly pleasant', he: 'קצת נעים' }, icon: 'leaf-outline', color: '#5fa977', order: 5 },
  { value: 6, label: 'Pleasant', translations: { en: 'Pleasant', he: 'נעים' }, icon: 'sunny-outline', color: '#e2a447', order: 6 },
  { value: 7, label: 'Very pleasant', translations: { en: 'Very pleasant', he: 'מאוד נעים' }, icon: 'heart-outline', color: '#d9737f', order: 7 },
];
